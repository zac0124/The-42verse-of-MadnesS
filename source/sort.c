...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/25 11:24:34 by zmunkhja          #+#    #+#             */
/*   Updated: 2023/03/25 11:24:35 by zmunkhja         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	shift_stack(t_stack **stack_a)
{
	...
	stack_size = get_stack_size(*stack_a);
	lowest_pos = get_the_lowest_index(stack_a);
...
void	sort(t_stack **stack_a, t_stack **stack_b)
{
	...
	while (*stack_b)
	{
		get_the_target_position(stack_a, stack_b);
